...
#	bgt $a0, $a1, start	 \	uncomment these lines if you
#	move $t9, $a0		  \		want to let the user an
#	move $a0, $a1		  /			option to insert the numbers
#	move $a1, $t9		 /				to be added, in any order he wants

# 20 real lines of code (with options)
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#	blt $t6, 32, okSrl	# the number of times to do srl <= 31 ? go to okSrl	 \	uncomment these lines if you want let 
#	li $t6, 31		# do the srl 31 times to make sgnificant2 = 0		  \		the user add numbers with exponent difference
# 	okSrl:										 /			  bigger than 31. to prevent srlv overflow		
